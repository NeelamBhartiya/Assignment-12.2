...
yeast <- read.table("C:\\Users\\Windows 10\\Desktop\\Neelam_ACADGILD\\Assignment\\yeast.data.txt", quote="\"", comment.char="")
View(yeast)
yeastdata <- yeast
dim(yeastdata)
...
x <- yeastdata$nuc
y <- hist(x, breaks = 10, col = "blue", xlab = "Score of discriminant analysis of nuclear localization signals
